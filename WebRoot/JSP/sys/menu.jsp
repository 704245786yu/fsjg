    ...
    <div  class="row" style="width:100%;padding:10px;">
		<div class="col-sm-4">
			<div class="input-group">
		      ...
		      <input type="text" class="form-control" id="searchText" placeholder="菜单名">
		    </div><!-- /input-group -->
	    </div><!-- /.col-sm-4 -->
	</div><!-- .row -->
	
	<!-- 数据表格 -->
	<table id="dg" data-toggle="table" data-url="menu/getAdjTree" 
	...
	<div class="modal-dialog" role="dialog" style="width:500px">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="formModalLabel">编辑菜单</h4>
			</div>
			<div class="modal-body">
				<form id="ff" method="post" class="form-horizontal" action="constantType/save">
					...
					<div class="form-group">
						<label for="menuName" class="col-sm-3 control-label">菜单名</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="menuName" name="menuName">
						</div>
					</div>
					<div class="form-group">
						<label for="path" class="col-sm-3 control-label">链接路径 </label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="path" name="path">
						</div>
					</div>
					<div class="form-group">
						<label for="imgPath" class="col-sm-3 control-label">图片路径 </label>
						<div class="col-sm-9">

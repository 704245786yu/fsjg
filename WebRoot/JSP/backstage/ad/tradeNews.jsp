...
<div id="tablePanel" class="panel panel-primary">
	...
	<div class="panel-body">
		...
		<div class="form-inline" style="padding-bottom:10px;">
			<div class="form-group">
				<label for="workerAmount">咨询标题</label>
	...
	<!-- 数据表格 -->
	<table id="dg" data-toggle="table" data-url="tradeNews/findByParam" data-unique-id="id" data-query-params="queryParams">
	    <thead>
	        <tr>
...
<div id="editPanel" class="panel panel-primary" style="display:none;">
	...
	<div class="panel-body">
		<form id="ff" method="post" class="form-horizontal" action="constantType/save">
			...
			<div class="form-group">
				<label for="constantTypeCode" class="col-sm-1 control-label">咨询详情 </label>
				<div class="col-sm-9">
...
<script src="JS/backstage/ad/tradeNews.js"></script>
</html>
